...
const PostBottom = ({ onSubmitHandler, addComment, addCommentsHandler }) => {
  return (
    <div className={classes['post-bottom']}>
      <button className={classes.btn} title='Like'>
        like
      </button>
      <div className={classes['comment-box']}>
        <form onSubmit={onSubmitHandler}>
          ...
          />
          <button className={classes['send-button']} onClick={onSubmitHandler}>
