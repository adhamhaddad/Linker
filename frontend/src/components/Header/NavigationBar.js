...
const NavigationBar = ({ requests, translation }) => {
    ...
    >
      ...
      <li>
        ...
        >
          ...
          <span>{translation('header.profile')}</span>
        </NavLink>
      </li>
      <li>
        <NavLink
        ...
        >
          ...
          <span>{translation('header.requests')}</span>
          {requests.length > 0 && (
      ...
      <li>
        <NavLink
          to='/messages'
          activeClassName={classes['active']}
          title={translation('header.messages')}
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
          ...
          <span>{translation('header.messages')}</span>
        </NavLink>
      </li>

      <li>
        <NavLink
          title={translation('header.notifications')}
          activeClassName={classes['active']}
          to='/notifications'
        >
          <svg
          ...
          <span>{translation('header.notifications')}</span>
        </NavLink>
      </li>

      <li className={classes['settings']}>
        <NavLink
          title={translation('header.settings')}
          activeClassName={classes['active']}
          to='/settings'
        >
          <svg
          ...
          <span>{translation('header.settings')}</span>
        </NavLink>
      </li>
    </ul>
  );
